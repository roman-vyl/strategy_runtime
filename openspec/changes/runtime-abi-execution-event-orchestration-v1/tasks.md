...
- [ ] 3.8 A `save(...)` exception propagates from `process(...)` unmodified,
  after exactly one save attempt.
- [ ] 3.9 The keyed mutex is released after normal completion and after any
...
- [ ] 3.10 `AbiExecutionEventOrchestrator.__init__` accepts exactly
  ...
  place.
- [ ] 3.11 A real integration test wires the actual
