# entry-reconciliation Specification

## Purpose

Define pure desired-entry reconciliation decisions, transport-free command and
confirmation values, fail-closed invariant handling, and acknowledged
current-cycle state transitions.
## Requirements
