# processing-journal Specification

## Purpose
Define best-effort versioned append-only JSONL observability for committed-bar orchestration lifecycle and per-strategy dispatch outcomes.
