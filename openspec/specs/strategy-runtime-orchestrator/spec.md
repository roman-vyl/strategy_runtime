...
through state get-or-create, open-position resolution, typed Strategy Engine
projection, typed post-projection handling, conditional persistence of a
logical state transition, and return of the final aggregate
...
- **THEN** the same keyed critical section remains held through repository
  ...
  the selected nested application operation, and any required save
