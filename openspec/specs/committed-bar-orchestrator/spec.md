# committed-bar-orchestrator Specification

## Purpose
Define the utility application coordinator that processes one committed bar through catalog discovery, exact deployment selection, deterministic per-instance dispatch, failure isolation, and semantic processing-journal calls.
