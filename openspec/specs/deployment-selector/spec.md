# deployment-selector Specification

## Purpose
Define the pure selection of enabled catalog deployments whose instrument and base timeframe exactly match one committed-bar event.
